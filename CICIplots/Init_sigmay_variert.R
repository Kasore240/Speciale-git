...
mtext("MU when initial guess of sigma y is changed",side=3,outer=TRUE, line=-1,cex.main=1.5)
...
title("For TMB",cex.main=0.8)
mtext("Theta when initial guess of sigma y is changed",side=3,outer=TRUE, line=-1,cex.main=1.5)
...
title("For TMB",cex.main=0.8)
mtext("Sigma x when initial guess of sigma y is changed",side=3,outer=TRUE, line=-1,cex.main=1.5)
...
title("For TMB",cex.main=0.8)
mtext("Sigma y when initial guess of sigma y is changed",side=3,outer=TRUE, line=-1,cex.main=1.5)
