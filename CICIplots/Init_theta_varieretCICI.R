...
load("C:/Users/bruger/OneDrive/Skrivebord/Speciale/Speciale-git/true data/Init_theta_vari_100.RData")
poOLD <- parms_org
sdOLD <- sd_org
...
#looking at sigy
#par(mfrow=c(1,2))
CICI(poOLD,isy[2],sdOLD,int_theta,log(1e-2),2)
title("Ctsmr",cex.main=0.8)
CICI(poTMB,isy[1],sdTMB,int_theta,log(1e-2),2)
title("CtsmrTMB",cex.main=0.8)
