...
plot(int_sig_x,apply((poOLD[,3,]),2,mean),pch=15,col="red",ylab = expression(paste('Mean of estimated vaue of ',mu)),xlab = expression(paste('Initial vale of ', sigma[x])))
points(int_sig_x,apply((poTMB[,2,]),2,mean),col="blue",pch=8)
legend("top",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
abline(h =1)

plot(int_sig_x,apply((poOLD[,3,]),2,sd),pch=15, col="red",ylab = expression(paste('Sd of estimated vaue of ',mu)),xlab = expression(paste('Initial vale of ', sigma[x])))
points(int_sig_x,apply((poTMB[,2,]),2,sd),col="blue",pch=8)
legend("top",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))

#theta
plot(int_sig_x,apply((poOLD[,4,]),2,mean),pch=15,col="red",ylab = expression(paste('Mean of estimated vaue of ',theta)),xlab = expression(paste('Initial vale of ', sigma[x])))
legend("bottomleft",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
points(int_sig_x,apply(exp(poTMB[,1,]),2,mean),col="blue",pch=8)
abline(h =10)

plot(int_sig_x,apply((poOLD[,4,]),2,sd),pch=15, col="red",ylab = expression(paste('Sd of estimated vaue of ',theta)),xlab = expression(paste('Initial vale of ', sigma[x])))
legend("topleft",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
points(int_sig_x,apply(exp(poTMB[,1,]),2,sd),col="blue",pch=8)

#sigx
plot(int_sig_x,apply(exp(poOLD[,1,]),2,mean),pch=15,col="red",ylim=c(0.96,1.03),ylab = expression(paste('Mean of estimated vaue of ',sigma[x])),xlab = expression(paste('Initial vale of ', sigma[x])))
legend("bottomleft",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
points(int_sig_x,apply(exp(poTMB[,3,]),2,mean),col="blue",pch=8)
abline(h =1)

plot(int_sig_x,apply(exp(poOLD[,1,]),2,sd),pch=15, col="red",ylab = expression(paste('Sd of estimated vaue of ',sigma[x])),xlab = expression(paste('Initial vale of ', sigma[x])))
legend("topleft",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
points(int_sig_x,apply(exp(poTMB[,3,]),2,sd),col="blue",pch=8)

#sigy

plot(int_sig_x,apply(exp(poOLD[,2,]),2,mean),pch=15,col="red",ylim=c(0.009,0.0103),ylab = expression(paste('Mean of estimated vaue of ',bold(sigma[y]))),xlab = expression(paste('Initial vale of ', sigma[x])))
legend("bottomleft",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
points(int_sig_x,apply(exp(poTMB[,4,]),2,mean),col="blue",pch=8)
abline(h =0.01)

plot(int_sig_x,apply(exp(poOLD[,2,]),2,sd),pch=15, col="red",ylim = c(0.0017,0.0028),ylab = expression(paste('Sd of estimated vaue of ',bold(sigma[y]))),xlab = expression(paste('Initial vale of ', sigma[x])))
legend("topleft",c('Org','TMB'),pch=c(15,8),col=c('red','blue'))
...
title("CtsmrTMB",cex.main=0.8)
mtext(expression(paste(theta, " when initial guess of ", simga[x], " is changed")),side=1,outer=TRUE, line=-15,cex.main=1.5)
...
title("CtsmrTMB",cex.main=0.8)
mtext(expression(paste(sigma[x], " when initial guess of ", simga[x], " is changed")),side=3,outer=TRUE, line=-1.5,cex.main=1.5)
...
title("CtsmrTMB",cex.main=0.8)
mtext(expression(paste(sigma[y], " when initial guess of ", simga[x], " is changed")),side=1,outer=TRUE, line=-15,cex.main=1.5)
