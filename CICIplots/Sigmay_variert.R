...
plot(int_sig_y ,apply((poOLD[,3,]),2,mean,na.rm=TRUE),pch=15,col="red",ylim = c(0.9,1.08),ylab = expression(paste('Mean of estimated vaue of ',mu)),xlab = expression(paste('Size of ', sigma[y])))
points(int_sig_y ,apply((poTMB[,2,]),2,mean,na.rm=TRUE),col="blue",pch=8)
legend("topleft",c('Ctsmr','CtsmrTMB'),pch=c(15,8),col=c('red','blue'))
abline(h =1)

plot(int_sig_y ,apply((poOLD[,3,]),2,sd,na.rm=TRUE),pch=15, col="red",ylab = expression(paste('Sd of estimated vaue of ',mu)),xlab = expression(paste('Size of ', sigma[y])))
points(int_sig_y ,apply((poTMB[,2,]),2,sd,na.rm=TRUE),col="blue",pch=8)
legend("topleft",c('Ctsmr','CtsmrTMB'),pch=c(15,8),col=c('red','blue'))

#theta
plot(int_sig_y ,apply((poOLD[,4,]),2,mean,na.rm=TRUE),pch=15,col="red",ylim = c(10,43), ylab = expression(paste('Mean of estimated vaue of ',theta)),xlab = expression(paste('Size of ', sigma[y])))
points(int_sig_y ,apply(exp(poTMB[,1,]),2,mean,na.rm=TRUE),col="blue",pch=8)
legend("topleft",c('Ctsmr','CtsmrTMB'),pch=c(15,8),col=c('red','blue'))
abline(h =10)

plot(int_sig_y ,apply((poOLD[,4,]),2,sd,na.rm=TRUE),pch=15, col="red",ylim=c(0,17),ylab = expression(paste('Sd of estimated vaue of ',theta)),xlab = expression(paste('Size of ', sigma[y])))
legend("topleft",c('Ctsmr','CtsmrTMB'),pch=c(15,8),col=c('red','blue'))
...
plot(int_sig_y ,apply(exp(poOLD[,2,]),2,mean,na.rm=TRUE),pch=15,col="red",ylab = expression(paste('Mean of estimated vaue of ',bold(sigma[y]))),xlab = expression(paste('Size of ', sigma[y])))
legend("topleft",c('Ctsmr','CtsmrTMB'),pch=c(15,8),col=c('red','blue'))
points(int_sig_y ,apply(exp(poTMB[,4,]),2,mean,na.rm=TRUE),col="blue",pch=8)
abline(0,1)

plot(int_sig_y ,apply(exp(poOLD[,2,]),2,sd,na.rm=TRUE),pch=15, col="red",ylab = expression(paste('Sd of estimated vaue of ',bold(sigma[y]))),xlab = expression(paste('Size of ', sigma[y])))
legend("topleft",c('Ctsmr','CtsmrTMB'),pch=c(15,8),col=c('red','blue'))
...
mtext(expression(paste(mu, " when size of ", sigma[y], " is changed")),side=3,outer=TRUE, line=-1.5,cex.main=1.5)
...
title("CtsmrTMB",cex.main=0.8)
mtext(expression(paste(theta, " when size of ", sigma[y], " is changed")),side=1,outer=TRUE, line=-18,cex.main=1.5)
...
title("CtsmrTMB",cex.main=0.8)
mtext(expression(paste(sigma[x], " when size of ", sigma[y], " is changed")),side=3,outer=TRUE, line=-1.5,cex.main=1.5)

#looking at sigy
#par(mfrow=c(1,2))
CICI(poOLD,isy[2],sdOLD,int_sig_y,log(int_sig_y),2)
title("Ctsmr",cex.main=0.8)
CICI(poTMB,isy[1],sdTMB,int_sig_y,log(int_sig_y),2)
title("CtsmrTMB",cex.main=0.8)
mtext(expression(paste(sigma[y], " when size of ", sigma[y], " is changed")),side=1,outer=TRUE, line=-20,cex.main=1.5)
