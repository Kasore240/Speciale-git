...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/sigmax_varieret_100.RData")
...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/sigmay_varieret_100.RData")
...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/Init_mu_vari_100.RData")
...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/Init_theta_vari_100.RData")
...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/init_x0_varieret_100.RData")
...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/init_sigmax_varieret_100.RData")
...
save(parms_org,sd_org,sd_tmb,parms_tmb,file = "data100small/init_sigmay_varieret_100.RData")